...
class _BookPageWidgetState extends State<BookPageWidget> {
  ...
  void initState() {
    super.initState();
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'Book_Page'});
                  ...
                  children: [
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'BOOK_arrow_back_outlined_ICN_ON_TAP');
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              widget.bookItem!.bookCompletedDate!,
                              style: FlutterFlowTheme.of(context)
                                  .bodyText2
                                  .override(
                                    fontFamily: 'Lexend Deca',
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'BOOK_PAGE_PAGE_ButtonPrimary_ON_TAP');
                          logFirebaseEvent('ButtonPrimary_Navigate-To');

                          context.pushNamed(
                            'UpdateBook',
                            queryParams: {
                              'bookUpdate': serializeParam(
                                  widget.bookItem, ParamType.Document),
                            }.withoutNulls,
                            extra: <String, dynamic>{
                              'bookUpdate': widget.bookItem,
                            },
                          );
                        },
                        text: 'Update Book Read',
                    ...
                    InkWell(
                      onTap: () async {
                        logFirebaseEvent('BOOK_PAGE_PAGE_Text_3mtbb26a_ON_TAP');
                        logFirebaseEvent('Text_Backend-Call');
                        await widget.bookItem!.reference.delete();
